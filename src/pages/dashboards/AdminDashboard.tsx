...
// Data reused/adapted from original Dashboard
const maturityTrendData = [
    { month: 'Jan', score: 45 }, { month: 'Feb', score: 52 },
    { month: 'Mar', score: 48 }, { month: 'Apr', score: 61 },
    { month: 'May', score: 68 }, { month: 'Jun', score: 72 },
];

const sectorData = [
    { name: 'Government', value: 400 }, { name: 'Health', value: 300 },
    { name: 'Education', value: 300 }, { name: 'Transport', value: 200 },
];

const pillarData = [
    { name: 'Strategy', score: 85 }, { name: 'Governance', score: 72 },
    { name: 'Infrastructure', score: 65 }, { name: 'Human Capital', score: 78 },
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-gray-500 mt-1">
                        Welcome back, {user?.name.split(' ')[1]}. Reviewing <span className="text-al-adaam font-bold uppercase tracking-wider text-sm">Cycle 2023-Q4</span>
                    </p>
                </div>
